    ...
    def choose_action(self):
        ...
        if self.learning:
            if is_random_exploration():
                ...
                # return self.valid_actions[random.randrange(start=0, stop=len(self.actions), step=1)]
                return random.choice(self.valid_actions)
            else:
                # TODO 7. Return action with highest q value
                # return sorted(self.qline, key=lambda x: self.qline[x])[-1]
            ...
            # TODO 6. Return random choose aciton
            # return self.actions[random.randrange(start=0, stop=len(self.actions), step=1)]
            return random.choice(self.valid_actions)
    ...
    def update_Qtable(self, r, action, next_state):
        ...
        if self.learning:
            ...
            q_target = r + self.gamma * \
                float(max(self.Qtable[next_state].values()))
            self.Qtable[self.state][action] = self.alpha * \
                q_target + (1 - self.alpha) * q_predict
